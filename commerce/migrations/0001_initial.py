    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency_of_payment', models.IntegerField(choices=[(1, 'USD'), (2, 'EUR'), (3, 'GBP')], default=commerce.utils.CurrencyTypes['USD'])),
                ...
                ('payment_type', models.IntegerField(choices=[(1, 'NONE'), (2, 'ONLINE'), (3, 'OFFLINE')], default=commerce.utils.PaymentTypes['ONLINE'])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('community_status', models.IntegerField(choices=[(1, 'DRONE'), (2, 'HONEY_BEE'), (3, 'TRUSTED_BEE'), (4, 'QUEEN_BEE'), (5, 'BEE_KEEPER')], default=commerce.utils.CommunityStatusOptions['DRONE'])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('reason', models.IntegerField(choices=[(1, 'BOUNTY'), (2, 'LIQUIDATION'), (3, 'REWARD')], default=0)),
                ('number_of_points', models.PositiveIntegerField()),
                ('type_of_points', models.IntegerField(choices=[(1, 'NONLIQUID'), (2, 'LIQUID')], default=commerce.utils.PointTypes['NONLIQUID'])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_points', models.IntegerField(default=500)),
                ('status', models.IntegerField(choices=[(1, 'NEW'), (2, 'COMPLETE'), (3, 'CANCELLED')], default=commerce.utils.LifecycleStatusOptions['NEW'])),
            ],
        ),
        migrations.CreateModel(
            name='InboundPayment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_points', models.PositiveIntegerField()),
                ('type_of_points', models.IntegerField(choices=[(1, 'NONLIQUID'), (2, 'LIQUID')], default=commerce.utils.PointTypes['NONLIQUID'])),
                ('credit_reason', models.IntegerField(choices=[(1, 'GRANT'), (2, 'SALE')], default=commerce.utils.OrganisationAccountCreditReasons['GRANT'])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_payable_in_cents', models.PositiveBigIntegerField()),
                ('payment_type', models.IntegerField(choices=[(1, 'NONE'), (2, 'ONLINE'), (3, 'OFFLINE')], default=commerce.utils.PaymentTypes['ONLINE'])),
                ('payment_status', models.IntegerField(choices=[(1, 'PENDING'), (2, 'PAID'), (3, 'CANCELLED'), (4, 'REFUNDED')], default=commerce.utils.PaymentStatusOptions['PENDING'])),
                ('process_status', models.IntegerField(choices=[(1, 'NEW'), (2, 'COMPLETE'), (3, 'CANCELLED')], default=commerce.utils.LifecycleStatusOptions['NEW'])),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='commerce.cart')),
                ('organisation_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='commerce.organisationaccount')),
                ('organisation_account_credit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='commerce.organisationaccountcredit')),
            ],
            options={
                'abstract': False,
            },

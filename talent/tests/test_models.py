...
class BountyClaimTest(TestCase):
    def setUp(self):
        ...
        self.claim_one = BountyClaimFactory(
            bounty=self.bounty_one, status=BountyClaim.Status.GRANTED
        )

        self.bounty_two = BountyFactory(points=100)
        self.claim_two = BountyClaimFactory(
            bounty=self.bounty_two, status=BountyClaim.Status.GRANTED
        )
    ...
    def test_save_one(self):
        ...
        self.claim_one.status = BountyClaim.Status.COMPLETED
        self.claim_one.save()
    ...
    def test_save_two(self):
        ...
        self.claim_two.status = BountyClaim.Status.COMPLETED
        self.claim_two.save()
    ...
    def test_save_three(self):
        ...
        self.claim_three.status = BountyClaim.Status.COMPLETED
        ...
        self.claim_four.status = BountyClaim.Status.COMPLETED

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='attachment',
            field=models.ManyToManyField(blank=True, related_name='product_attachments', to='product_management.attachment'),
        ),
        migrations.AddField(
            model_name='product',
            name='capability_start',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='product_management.capability'),
        ),
        migrations.AddField(
            model_name='product',
            name='owner',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='security.productowner'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='agreement',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_management.contributoragreement'),
        ),
        migrations.AddField(
            model_name='contributoragreementacceptance',
            name='person',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person_contributor_agreement_acceptance', to='talent.person'),
        ),
        migrations.AddField(
            model_name='contributoragreement',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_contributor_agreement', to='product_management.product'),
        ),
        migrations.AddField(
            model_name='challengelisting',
            name='assigned_to_person',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='challenge_listing', to='talent.person'),
        ),
        migrations.AddField(
            model_name='challengelisting',
            name='capability',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='product_management.capability'),
        ),
        migrations.AddField(
            model_name='challengelisting',
            name='challenge',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='product_management.challenge'),
        ),
        migrations.AddField(
            model_name='challengelisting',
            name='initiative',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='product_management.initiative'),
        ),
        migrations.AddField(
            model_name='challengelisting',
            name='product',
        ...
        migrations.AddField(
            ...
            name='attachment',
            field=models.ManyToManyField(blank=True, related_name='challenge_attachements', to='product_management.attachment'),
        ),
        migrations.AddField(
            model_name='challenge',
            name='capability',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='product_management.capability'),
        ),
        migrations.AddField(
            model_name='challenge',
            name='comments_start',
        ...
        migrations.AddField(
            model_name='challenge',
            name='expertise',
            field=models.ManyToManyField(related_name='challenge_expertise', to='talent.expertise'),
        ),
        migrations.AddField(
            model_name='challenge',
            name='initiative',
        ...
        migrations.AddField(
            model_name='challenge',
            name='skill',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='challenge', to='talent.skill'),
        ),
        migrations.AddField(
            model_name='challenge',
            name='tag',
            field=models.ManyToManyField(blank=True, related_name='challenge_tags', to='product_management.tag'),
        ),
        migrations.AddField(
            model_name='challenge',
            name='updated_by',
        ...
        migrations.AddField(
            ...
            name='attachment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_management.attachment'),
        ),
        migrations.AddField(
            model_name='capabilityattachment',
            name='capability',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_management.capability'),
        ),
        migrations.AddField(

...
from apps.talent.models import BountyClaim, BountyDeliveryAttempt
from apps.security.services import RoleService
from apps.product_management import forms
...
class PortalProductSettingView(LoginRequiredMixin, common_mixins.AttachmentMixin, UpdateView):
    ...
    template_name = "product_management/portal/product_settings.html"
    login_url = "sign_in"

    def get_success_url(self):
        return reverse("product-settings", args=(self.object.id,))
